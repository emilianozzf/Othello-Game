...
class Tiles:
    ...
    def flip_tiles(self, color, legal_moves):
        """Flip all the opposing tiles"""
        for direction in legal_moves.keys():
            for row_col in legal_moves[direction]:
                ...
                self.put_tile(
                    row_col[1]*self.SPACING,
                    row_col[0]*self.SPACING,
                    color
                )
